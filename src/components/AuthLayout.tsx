...
export function AuthLayout() {
	return (
		...
		>
			<main className="w-5xl mt-8 bg-gray-100 border rounded-t-3xl flex flex-col pt-12 items-center md:min-w-[465px] md:mt-3 md:rounded-tl-3xl md:rounded-tr-none">
